...
17 个目标在本轮源代码 BUILD.gn 中均有声明。下列“历史”专指上述 H13 receipt，NOT_RUN 不断言从未在其他候选执行。新候选每项目标必须实际枚举非零测试并执行，记录命令/退出码、summary、二进制哈希、sourceStable。

| unit target | H13 历史结果 | Q 新候选 |
| --- | --- | --- |
