...
- 0109–0113 补齐 GitHub 正式版本检查、安装包下载与校验、产品更新共享状态、准确的模型配置状态，以及设置和内置页面三语整改。
- 本地 macOS 验收为 Ver 1.1 (018)：32 项整改完成，18 项原生测试、116 项界面回归通过，170 条改动文案及翻译占位符检查通过。Windows/Android 实机及真实 Release 安装尚未验收；本次仅提交源码，不发布二进制或 tag。
