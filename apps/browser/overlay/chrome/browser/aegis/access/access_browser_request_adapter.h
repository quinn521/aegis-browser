...
// navigation cannot inherit the old page's authorization. Requests without a
// trusted WebContents/frame are rejected in this slice rather than borrowing an
// active tab identity.
