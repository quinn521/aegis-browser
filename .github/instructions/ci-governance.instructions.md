...
- Upstream Codacy analysis, independent review, hosted CI, and applicable integration validation are separate evidence sources. A success in one does not waive the others. Copilot review is optional supplementary evidence only when explicitly invoked; it is not an enabled workflow prerequisite.
